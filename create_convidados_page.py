...
export const ConvidadosPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {aba === 'padrinhos' && (
        <Modal
          titulo={editandoId ? 'Editar Padrinho' : 'Adicionar Padrinho'}
          aberta={modalAberta}
          onFechar={() => setModalAberta(false)}
...
with open('src/pages/ConvidadosPage.tsx', 'w', encoding='utf-8') as f:
    f.write(content)

import os
size = os.path.getsize('src/pages/ConvidadosPage.tsx')
